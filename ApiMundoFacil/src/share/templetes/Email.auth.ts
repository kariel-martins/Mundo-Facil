...
export function resetPasswordEmailTemplate(name: string, resetLink: string, token: string) {
  return `
  <!DOCTYPE html>
  <html>
    <head>
    ...
    <body>
      <div class="container">
        ...
        <a href="${urlFrontEnd}${resetLink}?token=${token}" class="button">Redefinir senha</a>
...
export function passwordResetSuccessEmailTemplate(name: string) {
  return `
  <!DOCTYPE html>
  <html>
    <head>
    ...
    <body>
      <div class="container">
        ...
        <p>Agora você já pode acessar sua conta normalmente utilizando sua nova senha.</p>
        <p>Se não foi você quem realizou essa alteração, entre em contato com o nosso suporte imediatamente.</p>

...
import { Plus, Store as StoreIcon } from "lucide-react"; // Importei Store como StoreIcon
        ...
        {isLoading ? (
          ...
          <div className="max-w-7xl mx-auto pt-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {/* Cards de Lojas Existentes (Clean) */}
              {store?.map((store) => (
                <Card
                  key={store.id}
              ...
              {/* Card para Cadastrar Nova Loja (Ação com Azul Claro) */}

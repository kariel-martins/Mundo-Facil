...
export function SearchPage() {
  ...
  const getProductDetails = (product: ProductData) => ({
    ...
    storeName: "Xcode",
    isOfficial: "Oficial",
    freeShipping: product.price > 100, // Exemplo de lógica de frete
  });
        ...
        <div className="flex space-x-8">
          ...
          <div className="w-64 flex-shrink-0 bg-white p-6 rounded-xl shadow-lg border border-gray-200 h-fit">
            ...
            <div className="space-y-3 text-sm text-gray-700">
              <label className="flex items-center space-x-2 cursor-pointer hover:text-blue-400 transition-colors">
                <input type="checkbox" className="form-checkbox text-blue-400 rounded border-gray-300 focus:ring-blue-400" />
              ...
              <Button variant="link" className="text-sm p-0 text-blue-400 h-auto mt-4 hover:text-blue-500">
                  Limpar Filtros
              </Button>
            </div>
          </div>
          ...
          <div className="flex-grow">
            {allProduct.isLoading ? (
              <p className="text-gray-600 font-medium">Buscando as melhores opções para você...</p>
              ...
              filtered?.map((product) => {
                ...
                return (
                  ...
                  >
                    {/* Imagem do Produto */}
                    <Link to={`/products/${details.id}`} className="flex-shrink-0">
                      <img
                        src={details.image}
                    ...
                    <div className="flex-grow flex justify-between">
                      <div className="flex flex-col justify-between">
                        ...
                        <div onClick={() => handleProductClick(details.id)}>
                          <Link to={`/products/${details.id}`} className="text-lg font-semibold text-gray-800 hover:text-blue-400 transition-colors">
                            {details.productName}
                          </Link>
                        ...
                        <div className="space-y-2 mt-2">
                          <p className="text-2xl font-extrabold text-gray-800">
                            R$ <span className="text-blue-500">{details.price}</span>
                          </p>
                      ...
                      <div className="w-56 flex-shrink-0 text-right space-y-2 pt-1">
                        ...
                        <Button
                          ...
                          onClick={() => handleProductClick(details.id)} // Adicionar ao carrinho ou ver detalhes
                        >
